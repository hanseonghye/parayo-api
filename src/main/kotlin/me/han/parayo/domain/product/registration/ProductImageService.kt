package me.han.parayo.domain.product.registration

import me.han.parayo.common.ParayoException
import me.han.parayo.domain.product.ProductImage
import me.han.parayo.domain.product.ProductImageRepository
...
class ProductImageService @Autowired constructor(
    ...
    : ProductImageUploadResponse {
        ...
        } ?: throw ParayoException("이미지 저장 실패. 다이 시도해주세요.")
    }
    ...
    private fun saveImageFile(image: MultipartFile): String {
        ...
        val thumbname = targetFile.absolutePath
